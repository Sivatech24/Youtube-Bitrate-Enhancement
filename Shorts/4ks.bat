...
REM ---------------- CONFIG ----------------
set "SRC=input.mov"
set "OUT_FOLDER=ETS2_4K_VERTICAL_444_10bit_NVENC"

REM Create output folder
if not exist "%OUT_FOLDER%" mkdir "%OUT_FOLDER%"

REM Output resolution and parameters
set "OUT_W=2160"
set "OUT_H=3840"
set "FPS=60"
...
REM Temporary folder for segments
...
for %%F in (tmp_segments\clip_*.mov) do (
    ...
    REM Small pause to free GPU memory
    timeout /t 1 >nul
)
